  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center ml-16 mt-40 mb-32">
          ...
          <div className="w-full md:w-full p-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-4">
                ...
                <input type="email" id="email" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-orange-500" placeholder="Yazınız" {...register("email", { required: true })}/>
              ...
              <div className="mb-4">
                ...
                <input type="password" id="password" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-orange-500" placeholder="Yazınız" {...register("password", { required: true })} />
                {errors.password && <span className='text-customOrange text-sm'>Bu alan boş bırakılamaz</span>}
              </div>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  <input type="checkbox" id="remember" className="h-4 w-4 text-orange-600 border-gray-300 rounded" />
        ...
        <div className="w-1/2 md:w-1/2 p-4 bg-white shadow-md ml-5 mb-44 border  rounded-md">
